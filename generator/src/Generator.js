...
async function write(dir, name, data) {
	...
	const path = `${__dirname}/../../src/main/resources/assets/${MOD}/${dir}`;
...
[cube, stairs, slab, pillar].forEach(f => TYPES.set(f.name, f));

const blocks = require('./blocks.json')

console.log(`Started Generator for ${blocks.length} blocks ...`)
